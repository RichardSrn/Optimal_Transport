...
def main():
    ...
    data = np.load("./artificial_data_no_noise.npy")[index, :, :]
    ...
    data = np.load("./artificial_data_no_noise.npy")
    ...
    bary_KBCM = np.load("./bary_KBCM_no_noise.npy").reshape((50,50))
    bary_TLp = np.load("./bary_TLp_no_noise.npy").reshape((50,50))
    barys_TLp = np.load("./barys_TLp_no_noise.npy").reshape((5,50,50))
